...
- **Note**: `historic_data` may be more recent than the training data. Time series models should refit to `historic_data` before forecasting. See `examples/arima_model/` for a demonstration.
