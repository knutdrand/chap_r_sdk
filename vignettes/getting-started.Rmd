...
The `chap.r.sdk` package provides infrastructure for developing disease forecasting models compatible with the [CHAP platform](https://github.com/dhis2/chap-core). CHAP (Climate and Health Analytics Platform) enables health ministries to run predictive models for disease surveillance.
