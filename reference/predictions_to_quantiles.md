...
Converts predictions from nested format to quantile format suitable for
forecast hub submissions. Computes specified quantiles from the sample
distribution.
...
- probs:
  ...
  Numeric vector of quantile probabilities (default: standard hub
  quantiles from 0.01 to 0.99)

## Value

A tibble in long format with columns: time_period, location, quantile,
value
