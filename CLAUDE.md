...
This project uses **renv** for reproducible dependency management at multiple levels:
...
- `init_chap_env()` - Initialize renv for a new model
- `generate_dockerfile()` - Auto-generate Dockerfile from renv.lock
