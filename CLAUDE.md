...
This is an R package (chapr) that provides convenience functionality for
developing Chap-compatible models and integrating existing models with
the Chap system. The package is tidyverse-oriented and follows R best
practices.
