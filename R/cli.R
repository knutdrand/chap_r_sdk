...
#'   and \code{model_configuration} is a list. Must return a tibble with a \code{samples}
#'   list-column containing numeric vectors. For deterministic models, use a single
