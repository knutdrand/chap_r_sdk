...
**Important**: `historic_data` may contain more recent observations than
training data. Time series models should refit to `historic_data` before
forecasting.
...
| Task                   | SDK handles it                                                                                          |
|------------------------|---------------------------------------------------------------------------------------------------------|
| Loading CSV files      | [`readr::read_csv()`](https://readr.tidyverse.org/reference/read_delim.html)                            |
| Converting to tsibbles | [`tsibble::as_tsibble()`](https://tsibble.tidyverts.org/reference/as-tsibble.html)                      |
| Detecting time columns | Finds `time_period`, `date`, `week`, etc.                                                               |
| Detecting key columns  | Finds `location`, `region`, etc.                                                                        |
| Loading/saving models  | [`readRDS()`](https://rdrr.io/r/base/readRDS.html) / [`saveRDS()`](https://rdrr.io/r/base/readRDS.html) |
| Parsing configs        | [`yaml::yaml.load_file()`](https://yaml.r-lib.org/reference/yaml.load.html)                             |
